...
public class JuegoSumaNumeros extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juego_suma_numeros);
        ...
        numerosAleatorios();
        GridViewAdapter adapter= new GridViewAdapter(JuegoSumaNumeros.this,numerosIconos,opciones);
